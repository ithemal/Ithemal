...
if __name__ == "__main__":
    ...
    raw_data = torch.load(args.datafile)
    ...
    model_name = '../saved/paper_seq_throughput.mdl'
    result_name = '../results/paper_seq_throughput.txt'
    ...
    model_name = '../saved/paper_hierarchical_throughput.mdl'
    result_name = '../results/paper_hierarchical_throughput.txt'
    ...
    model_name = '../saved/paper_graph_throughput.mdl'
    result_name = '../results/paper_graph_throughput.txt'
    ...
    result_name = '../results/paper_throughput_error.png'
